...
class PopSongsView extends StatefulWidget {
  @override
  _PopSongsViewState createState() => _PopSongsViewState();
}

class _PopSongsViewState extends State<PopSongsView> {
  bool searchon = false;
  String searchdata;
  List allsongs = [];
