...
class RomanticSongsView extends StatefulWidget {
  @override
  _RomanticSongsViewState createState() => _RomanticSongsViewState();
}

class _RomanticSongsViewState extends State<RomanticSongsView> {
  bool searchon = false;
  String searchdata;
  List allsongs = [];
