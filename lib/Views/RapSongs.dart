...
class RapSongsView extends StatefulWidget {
  @override
  _RapSongsViewState createState() => _RapSongsViewState();
}

class _RapSongsViewState extends State<RapSongsView> {
  bool searchon = false;
  String searchdata;
  List allsongs = [];
